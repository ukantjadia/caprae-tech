...
export default function Home() {
  return (
    <>
      <section className="hero" id="opening" data-signal="Opening">
        <HeroMedia />
        ...
        <div className="hero__inner">
          <div className="hero__lead">
            ...
            <div className="hero__cta">
              <Link className="btn btn--flame hero__go" to="/contact">
                Book a call
                <span className="btn__dot" aria-hidden="true"><ArrowRight /></span>
              </Link>
              <Link className="btn btn--ghost" to="/work">See the record</Link>
            </div>
      ...
      <section className="band shell" id="position" data-signal="Position">
      ...
      <section className="band band--hair shell" id="services" data-signal="Services">
        ...
        <Link className="btn btn--ghost cardgrid__more" to="/services">All services</Link>
      </section>

      <section className="band band--hair shell" id="evidence" data-signal="Evidence">
        <p className="eyebrow">The firm behind the team</p>
        <ul className="figures">
          <li><AnimatedNumber value={110} prefix="$" suffix="M+" /><span>closed, 2026 YTD<i>Caprae Capital, firm-wide</i></span></li>
          <li><AnimatedNumber value={20} suffix="%+" /><span>MoM growth, 14+ months<i>Caprae Capital, firm-wide</i></span></li>
          <li><AnimatedNumber value={8} /><span>countries serviced<i>Caprae Capital, firm-wide</i></span></li>
          <li><AnimatedNumber value={40} suffix="+" /><span>searchers supported<i>Caprae Capital, firm-wide</i></span></li>
        </ul>
      </section>
    </>
  )

...
export default function Services() {
  return (
    <>
      <section className="pagehead" id="services-opening" data-signal="Services">
        <HeroMedia short />
        <div className="shell">
      ...
      <section className="band shell" id="engagements" data-signal="Engagements">
        <ul className="svc">
          {services.map((s) => (
      ...
      <section className="band band--hair shell" id="process" data-signal="Process">

...
export default function Work() {
  return (
    <>
      <section className="pagehead" id="work-opening" data-signal="Record">
        <HeroMedia short />
        <div className="shell">
      ...
      <section className="band shell" id="products" data-signal="Products">
        <ul className="rec">
          {products.map((p) => (
      ...
      <section className="band band--hair shell" id="portfolio" data-signal="Portfolio">
